...
#-------------------------------------------- MODERATE PLAYER -------------------------------------------#
    def moderatePlayer(self, player, dealer, player_value, dealer_value):  # player com atitude moderada
        ...
        # dealer_prob_bust_estimated        -> probabilidade do dealer ter passado os 21 pontos tendo em conta a carta oculta tendo em conta a carta oculta tendo em conta a que o valor esperado da carta oculta é 6.85
        # dealer_prob_not_bust_estimated    -> probabilidade do dealer nao ter passado os 21 pontos tendo em conta a carta oculta tendo em conta a que o valor esperado da carta oculta é 6.85
        # dealer_prob_better_hand_estimated -> probabilidade do dealer melhorar a sua mao tendo em conta a que o valor esperado da carta oculta é 6.85
        # nDealer_prob_hit_estimated        -> probabilidade de dealer fazer hit na proxima jogada tendo em conta a que o valor esperado da carta oculta é 6.85
        #--------------------- CONDITIONS ---------------_#
    ...
    def writeFile(self, val, fileName):  # guarda info de jogadas no ficheiro, apenas para debug
        fileobj = open(fileName, "w")
        fileobj.write(str(val) + '\n')
        fileobj.close()

    def readFile(self, fileName):  # lê info de jogadas no ficheiro, apenas para debug
